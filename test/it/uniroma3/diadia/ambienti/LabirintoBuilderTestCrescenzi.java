...
public class LabirintoBuilderTestCrescenzi {
    ...
    public void testPiuDiQuattroAdiacenti() {
        Labirinto maze = labirintoBuilder
                ...
                //.addAdiacenza(nomeStanzaIniziale, "stanza 5", "nord-est") // non dovrebbe essere aggiunta // meglio fallire che tacere
                .getLabirinto();
                Stanza test = new Stanza("stanza 5");
        //assertNull(maze.getStanzaIniziale().getStanzaAdiacente("nord-est")); // meglio fallire che tacere
